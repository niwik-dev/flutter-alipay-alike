...
FetchVideoComments fetchVideoCommentsFromJson(String str) => FetchVideoComments.fromJson(json.decode(str));

String fetchVideoCommentsToJson(FetchVideoComments data) => json.encode(data.toJson());

class FetchVideoComments {
  int? statusCode;
  ...
  factory FetchVideoComments.fromJson(Map<String, dynamic> json) => FetchVideoComments(
