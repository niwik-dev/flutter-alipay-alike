...
FetchHomeFeed fetchHomeFeedFromJson(String str) => FetchHomeFeed.fromJson(json.decode(str));

String fetchHomeFeedToJson(FetchHomeFeed data) => json.encode(data.toJson());
...
class FetchHomeFeed {
  ...
  factory FetchHomeFeed.fromJson(Map<String, dynamic> json) => FetchHomeFeed(
